...
<CodeBlock url="https://github.com/toposware/docs" title="src/test.py">
```py
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]+)", r" [\\#\1](https://github.com/toposware/docs/issues/\1)", line.rstrip())
    print(line)
```
</CodeBlock>
...
![Illustration 2](./images/topos_header.png 'Title 2')
![Lorem ipsum dolor sit amet](./images/topos_header.png 'Title 3')
![Illustration 4](./images/topos_header.png 'Title 4')
